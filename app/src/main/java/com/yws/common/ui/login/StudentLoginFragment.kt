...
import com.yws.common.ui.mstudent.MainStudentActivity
...
class StudentLoginFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return ConstraintLayout(inflater.context).apply {
            ...
            TopBar("学生登录", buildCustomShape(0F, fillColor = 0xFFEEEEEE))
            ...
            loginBtn.addTo(this) {
                ...
                setOnClickListener {
                    lifecycleScope.launchWhenResumed {
                        val result = mViewModel.studentLogin(accountEdt.text.toString(), passwordEdt.text.toString())
                        when (result) {
                            is BaseResult.Success -> {
                                MainStudentActivity.startAction(requireActivity())
            ...
            TextView(context).addTo(this) {
                ...
                setOnClickListener {
                    mViewModel.switchToTeacherLogin()
                }
            }
        }
    }

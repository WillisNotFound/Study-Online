...
import com.yws.common.ui.mstudent.exam.StuExamingViewModel
 ...
 * <p>update: none
 */
class StuAnsingFragment : Fragment() {
    private val mViewModel by activityViewModels<StuExamingViewModel>()
    private var mPosition: Int = 0
    private var mSubjectId: Int? = null

    companion object {
        fun newInstance(fragmentManager: FragmentManager, position: Int, subjectId: Int): StuAnsingFragment {
            return StuAnsingFragment().apply {
                        ...
                        LinearLayout(context).addTo(this) {
                            ...
                            TextView(context).addTo(this) {
                                ...
                                setOnClickListener {
                                    ...
                                    Log.i("TeacherManager", "::$mPosition, ${answerEdt.text}")
                                    mViewModel.mAnswerList?.set(
                                        mPosition,

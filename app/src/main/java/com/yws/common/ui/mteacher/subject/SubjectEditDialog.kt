...
class SubjectEditDialog : DialogFragment() {
    ...
    companion object {
        suspend fun showDialog(fragmentManager: FragmentManager, subject: Subject): Subject? {
            return suspendCancellableCoroutine { continuation ->
                SubjectEditDialog().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return ConstraintLayout(inflater.context).apply {
            ...
            TopBar("编辑题目", buildCustomShape(CornetRadius(12.dpf, 12.dpf, 0F, 0F), fillColor = 0xFFEEEEEE))
            ...
            NestedScrollView(context).addTo(this) {
                ...
                LinearLayout(context).addTo(this) {
                    ...
                    var subjectType: SubjectType = mSubject?.type ?: SubjectType.FillIn
                    var difficulty: SubjectDifficulty = mSubject?.difficulty ?: SubjectDifficulty.Simple
                    var content: SubjectContent = mSubject?.content ?: SubjectContent.Text("")
                    var answer: SubjectAnswer = mSubject?.answer ?: SubjectAnswer.Text("")
                    ...
                    LinearLayout(context).addTo(this) {
                        ...
                        Spinner(context).addTo(this) {
                            ...
                            setSelection(array.indexOf(subjectType))
                        }
                    }
                    ...
                    LinearLayout(context).addTo(this) {
                        ...
                        Spinner(context).addTo(this) {
                            ...
                            setSelection(array.indexOf(difficulty))
                        }
                    }
                    ...
                    LinearLayout(context).addTo(this) {
                        ...
                        scoreEdt.addTo(this) {
                            ...
                            setMaxLength(2)
                            isSingleLine = true
                            setText(mSubject?.score.toString())
                        }
                    }
                    ...
                    contentEdt.addTo(this) {
                        ...
                        isSingleLine = false
                        hint = "题目内容（100字以内）"
                        setText(mSubject?.content?.simpleDesc)
                    }
                    ...
                    answerEdt.addTo(this) {
                        ...
                        isSingleLine = false
                        hint = "题目答案（100字以内）"
                        setText(mSubject?.answer?.simpleDesc)
                    }
